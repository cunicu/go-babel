...
require (
	github.com/onsi/ginkgo/v2 v2.11.0 // testing
	github.com/onsi/gomega v1.27.10 // testing
)
...
require (
	...
	github.com/gopacket/gopacket v1.1.2-0.20230727130822-916e2ade1109 // indirect
